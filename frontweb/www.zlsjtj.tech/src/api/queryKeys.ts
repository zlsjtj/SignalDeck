...
export const queryKeys = {
  ...
  marketIntelSummary: (symbol?: string, streamWindowSeconds?: number, lookbackBars?: number) => ['market', 'intel', symbol ?? 'default', streamWindowSeconds ?? 300, lookbackBars ?? 96] as const,
} as const;
